                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center" x-data="{ modalIsOpen: false }">
                                        ...
                                        <button x-on:click="modalIsOpen = true" type="button"
                                            class="text-red-600 hover:text-red-900 cursor-pointer" title="Hapus">
                                            ...
                                            <div x-show="modalIsOpen"
                                                ...
                                                <div class="px-4 py-6 text-left">
                                                    <p class="text-sm text-gray-600 whitespace-normal">Apakah Anda yakin
                                                        ingin menghapus data siswa ini? Jika dihapus, data tidak dapat
                                                        dikembalikan.</p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <form action="{{ route('admin.delete.student', $student->id) }}"
